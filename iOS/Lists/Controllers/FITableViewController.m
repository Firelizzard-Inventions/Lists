...
@implementation FITableViewController (Internal)
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForError:(NSNumber *)error
{
	...
	cell.detailTextLabel.text = [error stringValue];
	return cell;
}
...
/*@implementation FITableViewController (UITableViewDelegate)
...
/*@implementation FITableViewController (UITableViewDataSource)
